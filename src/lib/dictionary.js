export const dictionary = {
      ...
      <div className="mt-2 p-2 ">
        <div className="space-y-2">
          <div>
            ...
            <p className="text-sm">"Watching movies is fun"<br />
              "Oglądanie filmów jest przyjemne"</p>
          </div>

          <div>
            <p className="font-semibold">2. Present Continuous (czas teraźniejszy ciągły):</p>
            <p className="text-sm">"She is watching TV"<br />
              "Ona ogląda telewizję"</p>
          </div>
        </div>

        <div className="mt-2 text-sm">
          <p><span className="font-medium">Uwaga:</span> Forma "watching'" z apostrofem jest potoczna.</p>
        </div>
      </div>
    </div>
  ),
  ...
  "learn": (
    <div className="flex flex-col">
      ...
      <div className="mt-2 p-2 ">
        <p><span className="font-semibold">Część mowy:</span> czasownik</p>
        <p><span className="font-semibold">Formy:</span> learn/studented/studenting</p>
  ...
  "noun": (
    <div className="flex flex-col">
      ...
      <div className="mt-2 p-2 ">
        ...
        <p className="font-semibold mt-2">Przykłady:</p>
        <ul className="list-disc ml-4">
          <li><span className="font-medium">"dog"</span> (pies)</li>
          <li><span className="font-medium">"London"</span> (Londyn)</li>
          <li><span className="font-medium">"love"</span> (miłość)</li>
        </ul>

        <p className="font-semibold mt-2">Charakterystyka gramatyczna:</p>
        <ul className="list-disc ml-4">
          <li>Może występować w liczbie pojedynczej i mnogiej</li>
          <li>Może być dopełnieniem lub podmiotem w zdaniu</li>
          <li>W języku angielskim nie ma rodzajów gramatycznych</li>
        </ul>
      </div>
    </div>
  ),
  ...
  "rice": (
    <div className="flex flex-col">
      ...
      <div className="mt-2 p-2 ">
        ...
        <p className="font-semibold mt-2">Użycie gramatyczne:</p>
        <ul className="list-disc ml-4">
          <li>Rzeczownik niepoliczalny (uncountable noun)</li>
          <li>Stosuje się z czasownikiem w liczbie pojedynczej: "Rice is..."</li>
          <li>Do określenia ilości używa się wyrażeń: "a grain of rice", "a bowl of rice"</li>
        </ul>

        <p className="font-semibold mt-2">Przykłady zdań:</p>
        <ul className="list-disc ml-4">
          <li>"I eat rice every day" (Jem ryż codziennie)</li>
          <li>"This rice tastes delicious" (Ten ryż jest pyszny)</li>
        </ul>
      </div>
    </div>
  ),
  ...
  "whether": (
    <div className="flex flex-col">
      ...
      <div className="mt-2 p-2 ">
        ...
        <p className="font-semibold mt-2">Zastosowanie gramatyczne:</p>
        <ul className="list-disc ml-4">
          <li>Używany w zdaniach pytających pośrednich</li>
          <li>Często w połączeniu z "or not"</li>
          <li>Nie mylić z "if" - "whether" stosujemy gdy mamy na myśli "czy" w sensie alternatywy</li>
        </ul>

        <p className="font-semibold mt-2">Przykłady zdań:</p>
        <ul className="list-disc ml-4">
          <li>"I don't know whether to go" (Nie wiem, czy iść)</li>
          <li>"Tell me whether you agree" (Powiedz mi, czy się zgadzasz)</li>
          <li>"It depends on whether it rains" (To zależy od tego, czy będzie padać)</li>
        </ul>
      </div>
    </div>
  ),
  ...
  "verbs": (
    <div className="flex flex-col">
      <h3 className="font-bold">verbs</h3>
      <ol className="list-decimal ml-4">
        <li>czasowniki (gram.)</li>
        <li>czynności (noun, plural)</li>
      </ol>
    </div>
  ),
  ...
  "adverbs": (
    <div className="flex flex-col">
      <h3 className="font-bold">adverbs</h3>
      <ol className="list-decimal ml-4">
        <li>przysłówki (gram.)</li>
        <li>okoliczniki (noun, plural)</li>
      </ol>
    </div>
  ),
  ...
  "prepositions": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>przyimki (gram.)</li>
        <li>relacje przestrzenne (noun, plural)</li>
      </ol>
    </div>
  ),
  ...
  "conjunctions": (
    <div className="flex flex-col">
      <h3 className="font-bold">conjunctions</h3>
      <ol className="list-decimal ml-4">
        <li>spójniki (gram.)</li>
        <li>łączniki (noun, plural)</li>
      </ol>
    </div>
  ),
  ...
  "interjections": (
    <div className="flex flex-col">
      <h3 className="font-bold">interjections</h3>
      <ol className="list-decimal ml-4">
        <li>wykrzykniki (gram.)</li>
        <li>okrzyki (noun, plural)</li>
      </ol>
    </div>
  ),
  ...
  "naming": (
    <div className="flex flex-col">
      <h3 className="font-bold">naming</h3>
      <ol className="list-decimal ml-4">
  ...
  "most": (
    <div className="flex flex-col">
      <h3 className="font-bold">most</h3>
      <ol className="list-decimal ml-4">
      ...
      <div className="mt-2 p-2 ">
        ...
        <ul className="list-disc ml-4">
          ...
          <li>Quantifier: "most people"</li>
          <li>Noun: "the most I can do"</li>
        </ul>
      </div>
    </div>
  ),
    ...
    <div className="flex flex-col">
      ...
      <div className="mt-2 p-2 ">
        ...
        <ul className="list-disc ml-4">
          ...
          <li>Present participle: "building a house"</li>
          <li>Gerund: "Building takes time"</li>
        </ul>
      </div>
    </div>
  ),
  ...
  "proper": (
    <div className="flex flex-col">
      <h3 className="font-bold">proper</h3>
      <ol className="list-decimal ml-4">
        <li>właściwy (adj.)</li>
  ...
  "felix": (
    <div className="flex flex-col">
      <h3 className="font-bold">Felix</h3>
      <ol className="list-decimal ml-4">
  ...
  "buddhism": (
    <div className="flex flex-col">
      <h3 className="font-bold">Buddhism</h3>
      <ol className="list-decimal ml-4">
  ...
  "countable": (
    <div className="flex flex-col">
      <h3 className="font-bold">countable</h3>
      <ol className="list-decimal ml-4">
  ...
  "uncountable": (
    <div className="flex flex-col">
      <h3 className="font-bold">uncountable</h3>
      <ol className="list-decimal ml-4">
  ...
  "counted": (
    <div className="flex flex-col">
      <h3 className="font-bold">counted</h3>
      <ol className="list-decimal ml-4">
  ...
  "individually": (
    <div className="flex flex-col">
      <h3 className="font-bold">individually</h3>
      <ol className="list-decimal ml-4">
  ...
  "rice": (
    <div className="flex flex-col">
      <h3 className="font-bold">rice</h3>
      <ol className="list-decimal ml-4">
        <li>ryż (noun)</li>
      </ol>
      <div className="mt-2 p-2 ">
  ...
  "busy": (
    <div className="flex flex-col">
      <h3 className="font-bold">busy</h3>
      <ol className="list-decimal ml-4">
        <li>zajęty (adj.)</li>
        <li>ruchliwy (adj.)</li>
      </ol>
  ...
  "need": (
    <div className="flex flex-col">
      <h3 className="font-bold">need</h3>
      <ol className="list-decimal ml-4">
        <li>potrzeba (noun)</li>
  ...
  "probably": (
    <div className="flex flex-col">
      <h3 className="font-bold">probably</h3>
      <ol className="list-decimal ml-4">
  ...
  "can": (
    <div className="flex flex-col">
      <h3 className="font-bold">can</h3>
      <ol className="list-decimal ml-4">
        <li>móc (czasownik modalny)</li>
        <li>puszka (rzeczownik)</li>
        <li>potrafić</li>
      </ol>
      <p className="mt-2 text-sm italic">Example: "I can swim" - "Potrafię pływać"</p>
    </div>
  ),

  "be": (
    <div className="flex flex-col">
      <h3 className="font-bold">be</h3>
      <ol className="list-decimal ml-4">
        <li>być</li>
        <li>znajdować się</li>
        <li>istnieć</li>
  ...
  "tricky": (
    <div className="flex flex-col">
      <h3 className="font-bold">tricky</h3>
      <ol className="list-decimal ml-4">
        <li>podchwytliwy</li>
        <li>trudny</li>
        <li>zawiły</li>
  ...
  "because": (
    <div className="flex flex-col">
      <h3 className="font-bold">because</h3>
      <ol className="list-decimal ml-4">
        <li>ponieważ</li>
        <li>bo</li>
        <li>z powodu</li>
  ...
  "talk": (
    <div className="flex flex-col">
      <h3 className="font-bold">talk</h3>
      <ol className="list-decimal ml-4">
        <li>rozmawiać</li>
        <li>mówić</li>
        <li>rozmowa</li>
  ...
  "different": (
    <div className="flex flex-col">
      <h3 className="font-bold">different</h3>
      <ol className="list-decimal ml-4">
        <li>różny</li>
        <li>inny</li>
        <li>odmienny</li>
  ...
  "unspecified": (
    <div className="flex flex-col">
      <h3 className="font-bold">unspecified</h3>
      <ol className="list-decimal ml-4">
        <li>nieokreślony</li>
        <li>niesprecyzowany</li>
        <li>niejasny</li>
      </ol>
    </div>
  ),
  ...
  "started": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>rozpoczął/rozpoczęła</li>
        <li>zaczął/zaczęła</li>
        <li>zainicjował/zainicjowała</li>
      </ol>
    </div>
  ),
  ...
  "visited": (
    <div className="flex flex-col">
      <h3 className="font-bold">visited</h3>
      <ol className="list-decimal ml-4">
        <li>odwiedził/odwiedziła</li>
        <li>zwiedził/zwiedziła</li>
        <li>był/była w</li>
      </ol>
    </div>
  ),
  ...
  "paris": (
    <div className="flex flex-col">
      ...
      <p>Stolica Francji</p>
      <p className="mt-1">Tłumaczenie: <em>Paryż</em></p>
    </div>
  ),

  "say": (
    <div className="flex flex-col">
      <h3 className="font-bold">say</h3>
      <ol className="list-decimal ml-4">
        <li>mówić</li>
        <li>powiedzieć</li>
        <li>wypowiadać się</li>
      </ol>
    </div>
  ),
  ...
  "an": (
    <div className="flex flex-col">
      <h3 className="font-bold">an</h3>
      <p>Przedimek nieokreślony (przed samogłoską)</p>
      <p className="mt-1">Tłumaczenie: <em>[brak bezpośredniego odpowiednika]</em></p>
    </div>
  ),
  ...
  "lost": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>zgubił/zgubiła</li>
        <li>stracił/straciła</li>
        <li>przegrał/przegrała</li>
      </ol>
    </div>
  ),
  ...
  "lived": (
    <div className="flex flex-col">
      <h3 className="font-bold">lived</h3>
      <ol className="list-decimal ml-4">
        <li>mieszkał/mieszkała</li>
        <li>żył/żyła</li>
        <li>przeżył/przeżyła</li>
      </ol>
    </div>
  ),
  ...
  "since": (
    <div className="flex flex-col">
      <h3 className="font-bold">since</h3>
      <ol className="list-decimal ml-4">
        <li>od (czasu)</li>
        <li>ponieważ</li>
        <li>odkąd</li>
  ...
  "still": (
    <div className="flex flex-col">
      <h3 className="font-bold">still</h3>
      <ol className="list-decimal ml-4">
        <li>wciąż</li>
        <li>nadal</li>
        <li>spokojny</li>
  ...
  "eaten": (
    <div className="flex flex-col">
      <h3 className="font-bold">eaten</h3>
      <p>Imiesłów czasu przeszłego od <strong>eat</strong></p>
      <p className="mt-1">Tłumaczenie: <em>zjedzony</em></p>
    </div>
  ),

  "gone": (
    <div className="flex flex-col">
      <h3 className="font-bold">gone</h3>
      <p>Imiesłów czasu przeszłego od <strong>go</strong></p>
      <p className="mt-1">Tłumaczenie: <em>poszedł/poszła</em></p>
    </div>
  ),

  "haven't": (
    <div className="flex flex-col">
      <h3 className="font-bold">haven't</h3>
      <p>Skrót od: <strong>have not</strong></p>
      <p className="mt-1">Tłumaczenie: <em>nie mam/nie miałem</em></p>
    </div>
  ),

  "hasn't": (
    <div className="flex flex-col">
      <h3 className="font-bold">hasn't</h3>
      <p>Skrót od: <strong>has not</strong></p>
      <p className="mt-1">Tłumaczenie: <em>nie ma/nie miał</em></p>
    </div>
  ),
  ...
  "saw": (
    <div className="flex flex-col">
      <h3 className="font-bold">saw</h3>
      <p>Czas przeszły od <strong>see</strong></p>
      <p className="mt-1">Tłumaczenie: <em>zobaczył/zobaczyła</em></p>
    </div>
  ),
  ...
  "bought": (
    <div className="flex flex-col">
      <h3 className="font-bold">bought</h3>
      <p>Czas przeszły od <strong>buy</strong></p>
      <p className="mt-1">Tłumaczenie: <em>kupił/kupiła</em></p>
    </div>
  ),
  ...
  "ate": (
    <div className="flex flex-col">
      <h3 className="font-bold">ate</h3>
      <p>Czas przeszły od <strong>eat</strong></p>
      <p className="mt-1">Tłumaczenie: <em>zjadł/zjadła</em></p>
    </div>
  ),

  "sushi": (
    <div className="flex flex-col">
      <h3 className="font-bold">sushi</h3>
      <p>Japońska potrawa</p>
      <p className="mt-1">Tłumaczenie: <em>sushi</em></p>
    </div>
  ),
  ...
  "mentioned": (
    <div className="flex flex-col">
      <h3 className="font-bold">mentioned</h3>
      <ol className="list-decimal ml-4">
        <li>wspomniał/wspomniała</li>
        <li>wymienił/wymieniła</li>
        <li>zaznaczył/zaznaczyła</li>
      </ol>
    </div>
  ),
  ...
  "broken": (
    <div className="flex flex-col">
      <h3 className="font-bold">broken</h3>
      <ol className="list-decimal ml-4">
        <li>złamany</li>
        <li>zepsuty</li>
        <li>zniszczony</li>
  ...
  "affects": (
    <div className="flex flex-col">
      <h3 className="font-bold">affects</h3>
      <ol className="list-decimal ml-4">
        <li>wpływa</li>
        <li>oddziałuje</li>
        <li>dotyka</li>
  ...
  "entered": (
    <div className="flex flex-col">
      <h3 className="font-bold">entered</h3>
      <ol className="list-decimal ml-4">
        <li>wszedł/weszła</li>
        <li>wprowadził/wprowadziła</li>
        <li>wjechał/wjechała</li>
      </ol>
    </div>
  ),
  ...
  "sat": (
    <div className="flex flex-col">
      ...
      <p>Czas przeszły od <strong>sit</strong></p>
      <p className="mt-1">Tłumaczenie: <em>usiadł/usiadła</em></p>
    </div>
  ),
  ...
  "continues": (
    <div className="flex flex-col">
      <h3 className="font-bold">continues</h3>
      <ol className="list-decimal ml-4">
        <li>kontynuuje</li>
        <li>trwa</li>
        <li>nie przerywa</li>
  ...
  "choosing": (
    <div className="flex flex-col">
      <h3 className="font-bold">choosing</h3>
      <ol className="list-decimal ml-4">
        <li>wybieranie</li>
        <li>decydowanie się</li>
        <li>preferowanie</li>
      </ol>
    </div>
  ),
  ...
  "past": (
    <div className="flex flex-col">
      <h3 className="font-bold">past</h3>
      <ol className="list-decimal ml-4">
        <li>przeszłość (noun)</li>
        <li>przeszły (adj.)</li>
        <li>miniony (adj.)</li>
      </ol>
      <p className="mt-2 text-sm italic">Example: "In the past, we used to write letters"</p>
    </div>
  ),
  ...
  "vs": (
    <div className="flex flex-col">
      ...
      <p>Skrót od: <em>versus</em></p>
      <p className="mt-1">Tłumaczenie: <strong>kontra</strong></p>
    </div>
  ),

  "continuous": (
    <div className="flex flex-col">
      <h3 className="font-bold">continuous</h3>
      <ol className="list-decimal ml-4">
        <li>ciągły</li>
        <li>nieprzerwany</li>
        <li>w trakcie (gram.)</li>
      </ol>
      <p className="mt-2 text-sm italic">Gramatyka: forma czasownika</p>
    </div>
  ),

  "what's": (
    <div className="flex flex-col">
      <h3 className="font-bold">what's</h3>
      <p>Skrót od: <strong>what is</strong></p>
      <p className="mt-1">Tłumaczenie: <em>co jest</em></p>
    </div>
  ),

  "the": (
    <div className="flex flex-col">
      <h3 className="font-bold">the</h3>
      <p>Określnik angielski (brak bezpośredniego tłumaczenia)</p>
      <p className="mt-1 text-sm">Użycie zależy od kontekstu</p>
    </div>
  ),

  "difference": (
    <div className="flex flex-col">
      <h3 className="font-bold">difference</h3>
      <ol className="list-decimal ml-4">
        <li>różnica</li>
        <li>odmienność</li>
        <li>rozbieżność</li>
  ...
  "let's": (
    <div className="flex flex-col">
      <h3 className="font-bold">let's</h3>
      <p>Skrót od: <strong>let us</strong></p>
      <p className="mt-1">Tłumaczenie: <em>chodźmy</em></p>
    </div>
  ),
  ...
  "between": (
    <div className="flex flex-col">
      <h3 className="font-bold">between</h3>
      <ol className="list-decimal ml-4">
        <li>między</li>
        <li>pomiędzy</li>
        <li>wśród</li>
  ...
  "these": (
    <div className="flex flex-col">
      <h3 className="font-bold">these</h3>
      <ol className="list-decimal ml-4">
        <li>te (bliskie, mnogie)</li>
        <li>tacy</li>
        <li>takie</li>
      </ol>
    </div>
  ...
  "tenses": (
    <div className="flex flex-col">
      <h3 className="font-bold">tenses</h3>
      <p>Gramatyka: formy czasownikowe</p>
      <p className="mt-1">Tłumaczenie: <em>czasy gramatyczne</em></p>
    </div>
  ),

  "often": (
    <div className="flex flex-col">
      <h3 className="font-bold">often</h3>
      <ol className="list-decimal ml-4">
        <li>często</li>
        <li>wielokrotnie</li>
        <li>regularnie</li>
  ...
  "confuse": (
    <div className="flex flex-col">
      <h3 className="font-bold">confuse</h3>
      <ol className="list-decimal ml-4">
        <li>mylić</li>
        <li>dezorientować</li>
        <li>mieszać</li>
  ...
  "each": (
    <div className="flex flex-col">
      <h3 className="font-bold">each</h3>
      <ol className="list-decimal ml-4">
        <li>każdy</li>
        <li>każda</li>
        <li>każde</li>
  ...
  "has": (
    <div className="flex flex-col">
      <h3 className="font-bold">has</h3>
      <p>Forma czasownika <strong>have</strong> dla:</p>
      <ol className="list-decimal ml-4">
        <li>he (on)</li>
        <li>she (ona)</li>
        <li>it (ono)</li>
  ...
  "uses": (
    <div className="flex flex-col">
      <h3 className="font-bold">uses</h3>
      <ol className="list-decimal ml-4">
        <li>używa</li>
        <li>zastosowania</li>
        <li>wykorzystania</li>
  ...
  "you": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>ty</li>
        <li>wy</li>
        <li>się (w niektórych konstrukcjach)</li>
      </ol>
    </div>
  ),
  ...
  "that": (
    <div className="flex flex-col">
      <h3 className="font-bold">that</h3>
      <ol className="list-decimal ml-4">
        <li>że</li>
        <li>tamten</li>
        <li>który</li>
  ...
  "happened": (
    <div className="flex flex-col">
      <h3 className="font-bold">happened</h3>
      <ol className="list-decimal ml-4">
        <li>wydarzyło się</li>
        <li>zdarzyło się</li>
        <li>stało się</li>
  ...
  "once": (
    <div className="flex flex-col">
      <h3 className="font-bold">once</h3>
      <ol className="list-decimal ml-4">
        <li>raz</li>
        <li>kiedyś</li>
        <li>gdy tylko</li>
  ...
  "are": (
    <div className="flex flex-col">
      <h3 className="font-bold">are</h3>
      <p>Forma czasownika <strong>be</strong> dla:</p>
      <ol className="list-decimal ml-4">
        <li>you (ty/wy)</li>
        <li>we (my)</li>
        <li>they (oni)</li>
  ...
  "include": (
    <div className="flex flex-col">
      <h3 className="font-bold">include</h3>
      <ol className="list-decimal ml-4">
        <li>zawierać</li>
        <li>włączać</li>
        <li>uwzględniać</li>
  ...
  "markers": (
    <div className="flex flex-col">
      <h3 className="font-bold">markers</h3>
      <ol className="list-decimal ml-4">
        <li>znaczniki</li>
        <li>wskaźniki</li>
        <li>markery</li>
  ...
  "yesterday": (
    <div className="flex flex-col">
      ...
      <p>Określenie czasu</p>
      <p className="mt-1">Tłumaczenie: <em>wczoraj</em></p>
    </div>
  ),
  ...
  "etc": (
    <div className="flex flex-col">
      <h3 className="font-bold">etc</h3>
      <p>Skrót od: <em>et cetera</em></p>
      <p className="mt-1">Tłumaczenie: <strong>i tak dalej</strong></p>
    </div>
  ),
  ...
  "with": (
    <div className="flex flex-col">
      <h3 className="font-bold">with</h3>
      <ol className="list-decimal ml-4">
        <li>z</li>
        <li>wraz z</li>
        <li>przy pomocy</li>
  ...
  "explanations": (
    <div className="flex flex-col">
      <h3 className="font-bold">explanations</h3>
      <ol className="list-decimal ml-4">
        <li>wyjaśnienia</li>
        <li>objaśnienia</li>
        <li>tłumaczenia</li>
  ...
  "i": (
    <div className="flex flex-col">
      ...
      <p>Zaimek osobowy pierwszej osoby</p>
      <p className="mt-1">Tłumaczenie: <em>ja</em></p>
    </div>
  ),

  "watched": (
    <div className="flex flex-col">
      <h3 className="font-bold">watched</h3>
      <ol className="list-decimal ml-4">
        <li>oglądałem/oglądałam</li>
        <li>obserwowałem/obserwowałam</li>
        <li>pilnowałem/pilnowałam</li>
      </ol>
    </div>
  ),
  ...
  "movie": (
    <div className="flex flex-col">
      <h3 className="font-bold">movie</h3>
      <ol className="list-decimal ml-4">
        <li>film</li>
        <li>kino</li>
        <li>ruchomy obraz</li>
  ...
  "marker": (
    <div className="flex flex-col">
      <h3 className="font-bold">marker</h3>
      <ol className="list-decimal ml-4">
        <li>znacznik</li>
        <li>flamaster</li>
        <li>wskaźnik</li>
  ...
  "she": (
    <div className="flex flex-col">
      <h3 className="font-bold">she</h3>
      <p>Zaimek osobowy trzeciej osoby żeńskiej</p>
      <p className="mt-1">Tłumaczenie: <em>ona</em></p>
    </div>
  ),

  "studied": (
    <div className="flex flex-col">
      <h3 className="font-bold">studied</h3>
      <ol className="list-decimal ml-4">
        <li>studiowała/studiował</li>
        <li>uczyła się/uczył się</li>
        <li>badała/badał</li>
      </ol>
    </div>
  ),
  ...
  "french": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>francuski (język)</li>
        <li>Francuz/Francuzka</li>
        <li>francuski (przymiotnik)</li>
      </ol>
    </div>
  ),
  ...
  "it's": (
    <div className="flex flex-col">
      <h3 className="font-bold">it's</h3>
      <p>Skrót od: <strong>it is</strong></p>
      <p className="mt-1">Tłumaczenie: <em>to jest</em></p>
    </div>
  ),
  ...
  "they": (
    <div className="flex flex-col">
      <h3 className="font-bold">they</h3>
      <p>Zaimek osobowy trzeciej osoby mnogiej</p>
      <p className="mt-1">Tłumaczenie: <em>oni/one</em></p>
    </div>
  ),

  "went": (
    <div className="flex flex-col">
      <h3 className="font-bold">went</h3>
      <p>Czas przeszły od <strong>go</strong></p>
      <p className="mt-1">Tłumaczenie: <em>poszedł/poszła/poszli</em></p>
    </div>
  ),
  ...
  "park": (
    <div className="flex flex-col">
      <h3 className="font-bold">park</h3>
      <ol className="list-decimal ml-4">
        <li>park</li>
        <li>parkować</li>
        <li>teren zielony</li>
  ...
  "played": (
    <div className="flex flex-col">
      <h3 className="font-bold">played</h3>
      <ol className="list-decimal ml-4">
        <li>grał/grała</li>
        <li>bawił się/bawiła się</li>
        <li>odgrywał/odgrywała</li>
      </ol>
    </div>
  ),
  ...
  "quick": (
    <div className="flex flex-col">
      <h3 className="font-bold">quick</h3>
      <ol className="list-decimal ml-4">
        <li>szybki</li>
        <li>prędki</li>
        <li>żywotny</li>
  ...
  "walked": (
    <div className="flex flex-col">
      <h3 className="font-bold">walked</h3>
      <ol className="list-decimal ml-4">
        <li>szedł/szła</li>
        <li>spacerował/spacerowała</li>
        <li>przechodził/przechodziła</li>
      </ol>
    </div>
  ),
  ...
  "he": (
    <div className="flex flex-col">
      <h3 className="font-bold">he</h3>
      <p>Zaimek osobowy trzeciej osoby męskiej</p>
      <p className="mt-1">Tłumaczenie: <em>on</em></p>
    </div>
  ),

  "didn't": (
    <div className="flex flex-col">
      <h3 className="font-bold">didn't</h3>
      <p>Skrót od: <strong>did not</strong></p>
      <p className="mt-1">Tłumaczenie: <em>nie zrobił</em></p>
    </div>
  ),
  ...
  "did": (
    <div className="flex flex-col">
      <h3 className="font-bold">did</h3>
      <p>Czas przeszły od <strong>do</strong></p>
      <p className="mt-1">Używane w pytaniach i przeczeniach</p>
    </div>
  ),
  ...
  "happening": (
    <div className="flex flex-col">
      <h3 className="font-bold">happening</h3>
      <ol className="list-decimal ml-4">
        <li>wydarzenie</li>
        <li>dziejący się</li>
        <li>zdarzający się</li>
      </ol>
    </div>
  ),
  ...
  "at": (
    <div className="flex flex-col">
      <h3 className="font-bold">at</h3>
      <ol className="list-decimal ml-4">
        <li>przy</li>
        <li>w (określonym miejscu)</li>
        <li>na</li>
      </ol>
    </div>
  ),
  ...
  "specific": (
    <div className="flex flex-col">
      <h3 className="font-bold">specific</h3>
      <ol className="list-decimal ml-4">
        <li>konkretny</li>
        <li>szczególny</li>
        <li>specyficzny</li>
  ...
  "interrupted": (
    <div className="flex flex-col">
      <h3 className="font-bold">interrupted</h3>
      <ol className="list-decimal ml-4">
        <li>przerwany</li>
        <li>zakłócony</li>
        <li>wtrącony</li>
  ...
  "descriptions": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>opisy</li>
        <li>charakterystyki</li>
        <li>przedstawienia</li>
      </ol>
    </div>
  ),
  ...
  "was": (
    <div className="flex flex-col">
      <h3 className="font-bold">was</h3>
      <p>Czas przeszły od <strong>be</strong> dla:</p>
      <ol className="list-decimal ml-4">
        <li>I (ja)</li>
        <li>he (on)</li>
        <li>she (ona)</li>
  ...
  "watching": (
    <div className="flex flex-col">
      <h3 className="font-bold">watching</h3>
      <ol className="list-decimal ml-4">
        <li>oglądający</li>
        <li>obserwujący</li>
        <li>patrzący</li>
  ...
  "tv": (
    <div className="flex flex-col">
      ...
      <p>Skrót od: <em>television</em></p>
      <p className="mt-1">Tłumaczenie: <strong>telewizja</strong></p>
    </div>
  ),
  ...
  "pm": (
    <div className="flex flex-col">
      ...
      <p>Skrót od: <em>post meridiem</em></p>
      <p className="mt-1">Tłumaczenie: <strong>po południu</strong></p>
    </div>
  ),
  ...
  "moment": (
    <div className="flex flex-col">
      <h3 className="font-bold">moment</h3>
      <ol className="list-decimal ml-4">
        <li>chwila</li>
        <li>moment</li>
        <li>bieżąca sytuacja</li>
      </ol>
    </div>
  ),
  ...
  "cooking": (
    <div className="flex flex-col">
      ...
      <ol className="list-decimal ml-4">
        <li>gotowanie</li>
        <li>przygotowywanie jedzenia</li>
        <li>kucharzenie</li>
      </ol>
    </div>
  ),
  ...
  "arrived": (
    <div className="flex flex-col">
      <h3 className="font-bold">arrived</h3>
      <ol className="list-decimal ml-4">
        <li>przybył/przybyła</li>
        <li>przyjechał/przyjechała</li>
        <li>dotarł/dotarła</li>
      </ol>
    </div>
  ),
  ...
  "another": (
    <div className="flex flex-col">
      <h3 className="font-bold">another</h3>
      <ol className="list-decimal ml-4">
        <li>inny</li>
        <li>jeszcze jeden</li>
        <li>kolejny</li>
  ...
  "raining": (
    <div className="flex flex-col">
      <h3 className="font-bold">raining</h3>
      <ol className="list-decimal ml-4">
        <li>pada (deszcz)</li>
        <li>deszczowy</li>
        <li>moknący</li>
  ...
  "blowing": (
    <div className="flex flex-col">
      <h3 className="font-bold">blowing</h3>
      <ol className="list-decimal ml-4">
        <li>wieje</li>
        <li>dmuchający</li>
        <li>wybuchający</li>
  ...
  "describes": (
    <div className="flex flex-col">
      <h3 className="font-bold">describes</h3>
      <ol className="list-decimal ml-4">
        <li>opisuje</li>
        <li>przedstawia</li>
        <li>charakteryzuje</li>
      </ol>
    </div>
  ),
  ...
  "eating": (
    <div className="flex flex-col">
      <h3 className="font-bold">eating</h3>
      <ol className="list-decimal ml-4">
        <li>jedzenie</li>
        <li>spożywanie</li>
        <li>jadanie</li>
  ...
  "were": (
    <div className="flex flex-col">
      <h3 className="font-bold">were</h3>
      <p>Czas przeszły od <strong>be</strong> dla:</p>
      <ol className="list-decimal ml-4">
        <li>you (ty/wy)</li>
        <li>we (my)</li>
  ...
  "wasn't": (
    <div className="flex flex-col">
      <h3 className="font-bold">wasn't</h3>
      <p>Skrót od: <strong>was not</strong></p>
      <p className="mt-1">Tłumaczenie: <em>nie był/nie była</em></p>
    </div>
  ),
  ...
  "them": (
    <div className="flex flex-col">
      <h3 className="font-bold">them</h3>
      <ol className="list-decimal ml-4">
        <li>ich (dopełnienie)</li>
        <li>im</li>
        <li>nie (w niektórych konstrukcjach)</li>
      </ol>
    </div>
  ),
  ...
  "finishing": (
    <div className="flex flex-col">
      <h3 className="font-bold">finishing</h3>
      <ol className="list-decimal ml-4">
        <li>kończenie</li>
        <li>wykończenie</li>
        <li>finalizowanie</li>
  ...
  "on": (
    <div className="flex flex-col">
      <h3 className="font-bold">on</h3>
      <ol className="list-decimal ml-4">
        <li>na (powierzchni)</li>
        <li>w (o urządzeniach)</li>
        <li>o (temat)</li>
      </ol>
    </div>
  ),
  ...
  "called": (
    <div className="flex flex-col">
      <h3 className="font-bold">called</h3>
      <ol className="list-decimal ml-4">
        <li>zadzwonił/zadzwoniła</li>
        <li>nazwany</li>
        <li>wezwany</li>
      </ol>
    </div>
  ...
  "sleeping": (
    <div className="flex flex-col">
      <h3 className="font-bold">sleeping</h3>
      <ol className="list-decimal ml-4">
        <li>śpiący</li>
        <li>spanie</li>
        <li>uśpiony</li>
  ...
  "one": (
    <div className="flex flex-col">
      <h3 className="font-bold">one</h3>
      <ol className="list-decimal ml-4">
        <li>jeden</li>
        <li>pewien</li>
        <li>osoba (nieokreślona)</li>
      </ol>
    </div>
  ),
  ...
  "interrupts": (
    <div className="flex flex-col">
      <h3 className="font-bold">interrupts</h3>
      <ol className="list-decimal ml-4">
        <li>przerywa</li>
        <li>zakłóca</li>
        <li>wtrąca się</li>
  ...
  "birds": (
    <div className="flex flex-col">
      <h3 className="font-bold">birds</h3>
      <ol className="list-decimal ml-4">
        <li>ptaki</li>
        <li>ptactwo</li>
        <li>lotnicy</li>
  ...
  "singing": (
    <div className="flex flex-col">
      <h3 className="font-bold">singing</h3>
      <ol className="list-decimal ml-4">
        <li>śpiewanie</li>
        <li>śpiewający</li>
        <li>śpiew</li>
  ...
  "choose": (
    <div className="flex flex-col">
      <h3 className="font-bold">choose</h3>
      <ol className="list-decimal ml-4">
        <li>wybierać</li>
        <li>decydować się</li>
        <li>preferować</li>
  ...
  "tense": (
    <div className="flex flex-col">
      <h3 className="font-bold">tense</h3>
      <ol className="list-decimal ml-4">
        <li>czas gramatyczny</li>
        <li>napięty</li>
        <li>spięty</li>
      </ol>
    </div>
  ...
  "present": (
    <div className=" font-normal flex flex-col">
      <p>present</p>
      <ol className=" font-normal list-decimal ml-4">
        <li>teraźniejszy (adj.)</li>
        <li>obecny (adj.)</li>
        <li>prezent (noun)</li>
      </ol>
      <p className=" font-normal mt-2 text-sm italic">Example: "I'm present at the meeting"</p>
    </div>
  ),
  ...
  "vs": (
    <div className=" font-normal flex flex-col">
      <p>vs</p>
      <p>Skrót od: <em>versus</em></p>
      <p className=" font-normal mt-1">Tłumaczenie: <strong>kontra</strong></p>
    </div>
  ),
  ...
  "continuous": (
    <div className=" font-normal flex flex-col">
      ...
      <p className=" font-normal mt-2 text-sm italic">Gramatyka: forma czasownika</p>
    </div>
  ),
  ...
  "what's": (
    <div className=" font-normal flex flex-col">
      <p>what's</p>
      <p>Skrót od: <strong>what is</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>co jest</em></p>
    </div>
  ),
  ...
  "the": (
    <div className=" font-normal flex flex-col">
      <p>the</p>
      <p>Określnik angielski (brak bezpośredniego tłumaczenia)</p>
      <p className=" font-normal mt-1 text-sm">Użycie zależy od kontekstu</p>
    </div>
  ),
  ...
  "let's": (
    <div className=" font-normal flex flex-col">
      <p>let's</p>
      <p>Skrót od: <strong>let us</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>chodźmy</em></p>
    </div>
  ),
  ...
  "a": (
    <div className=" font-normal flex flex-col">
      <p>a</p>
      <p>Przedimek nieokreślony</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>[brak bezpośredniego odpowiednika]</em></p>
    </div>
  ),
  ...
  "english": (
    <div className=" font-normal flex flex-col">
      <p>english</p>
      <ol className=" font-normal list-decimal ml-4">
        <li>angielski (język)</li>
        <li>Anglik</li>
        <li>angielszczyzna</li>
      </ol>
    </div>
  ),
  ...
  "tenses": (
    <div className=" font-normal flex flex-col">
      <p>tenses</p>
      <p>Gramatyka: formy czasownikowe</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>czasy gramatyczne</em></p>
    </div>
  ),
  ...
  "it's": (
    <div className=" font-normal flex flex-col">
      <p>it's</p>
      <p>Skrót od: <strong>it is</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>to jest</em></p>
    </div>
  ),
  ...
  "don't": (
    <div className=" font-normal flex flex-col">
      <p>don't</p>
      <p>Skrót od: <strong>do not</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>nie rób</em></p>
    </div>
  ),
  ...
  "i": (
    <div className=" font-normal flex flex-col">
      <p>I</p>
      <p>Zaimek osobowy pierwszej osoby</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>ja</em></p>
    </div>
  ),
  ...
  "she": (
    <div className=" font-normal flex flex-col">
      <p>she</p>
      <p>Zaimek osobowy trzeciej osoby żeńskiej</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>ona</em></p>
    </div>
  ),
  ...
  "her": (
    <div className=" font-normal flex flex-col">
      <p>her</p>
      <ol className=" font-normal list-decimal ml-4">
        <li>jej (dopełniacz)</li>
        <li>ją (biernik)</li>
        <li>ona (po przyimku)</li>
      </ol>
    </div>
  ),
  ...
  "sun": (
    <div className=" font-normal flex flex-col">
      ...
      <ol className=" font-normal list-decimal ml-4">
        <li>słońce</li>
        <li>nasłonecznienie</li>
        <li>wystawiać na słońce</li>
      </ol>
    </div>
  ),
  ...
  "they": (
    <div className=" font-normal flex flex-col">
      <p>they</p>
      <p>Zaimek osobowy trzeciej osoby mnogiej</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>oni/one</em></p>
    </div>
  ),
  ...
  "we": (
    <div className=" font-normal flex flex-col">
      <p>we</p>
      <p>Zaimek osobowy pierwszej osoby mnogiej</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>my</em></p>
    </div>
  ),
  ...
  "he": (
    <div className=" font-normal flex flex-col">
      <p>he</p>
      <p>Zaimek osobowy trzeciej osoby męskiej</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>on</em></p>
    </div>
  ),
  ...
  "doesn't": (
    <div className=" font-normal flex flex-col">
      <p>doesn't</p>
      <p>Skrót od: <strong>does not</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>nie robi</em></p>
    </div>
  ),
  ...
  "does": (
    <div className=" font-normal flex flex-col">
      <p>does</p>
      <p>Forma czasownika <strong>do</strong> dla:</p>
      <ol className=" font-normal list-decimal ml-4">
        <li>he (on)</li>
        <li>she (ona)</li>
        <li>it (ono)</li>
  ...
  "i'm": (
    <div className=" font-normal flex flex-col">
      <p>I'm</p>
      <p>Skrót od: <strong>I am</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>jestem</em></p>
    </div>
  ),
  ...
  "you're": (
    <div className=" font-normal flex flex-col">
      <p>you're</p>
      <p>Skrót od: <strong>you are</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>jesteś/jesteście</em></p>
    </div>
  ),
  ...
  "my": (
    <div className=" font-normal flex flex-col">
      <p>my</p>
      <p>Zaimek dzierżawczy pierwszej osoby</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>mój/moja/moje</em></p>
    </div>
  ),
  ...
  "isn't": (
    <div className=" font-normal flex flex-col">
      <p>isn't</p>
      <p>Skrót od: <strong>is not</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>nie jest</em></p>
    </div>
  ),
  ...
  "your": (
    <div className=" font-normal flex flex-col">
      <p>your</p>
      <p>Zaimek dzierżawczy drugiej osoby</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>twój/twoja/twoje</em></p>
    </div>
  ),
  ...
  "that's": (
    <div className=" font-normal flex flex-col">
      <p>that's</p>
      <p>Skrót od: <strong>that is</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>to jest</em></p>
    </div>
  ),
  ...
  "he's": (
    <div className=" font-normal flex flex-col">
      <p>he's</p>
      <p>Skrót od: <strong>he is</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>on jest</em></p>
    </div>
  ),
  ...
  "his": (
    <div className=" font-normal flex flex-col">
      <p>his</p>
      <p>Zaimek dzierżawczy trzeciej osoby męskiej</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>jego</em></p>
    </div>
  ),
  ...
  "she's": (
    <div className=" font-normal flex flex-col">
      <p>she's</p>
      <p>Skrót od: <strong>she is</strong></p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>ona jest</em></p>
    </div>
  ),
  ...
  "breakfast": (
    <div className=" font-normal flex flex-col">
      ...
      <ol className=" font-normal list-decimal ml-4">
        <li>śniadanie</li>
        <li>jeść śniadanie</li>
        <li>poranny posiłek</li>
      </ol>
    </div>
  ),
  ...
  "am": (
    <div className=" font-normal flex flex-col">
      <p>am</p>
      <p>Forma czasownika <strong>be</strong> dla:</p>
      <p className=" font-normal mt-1">I (ja)</p>
    </div>
  ),
  ...
  "london": (
    <div className=" font-normal flex flex-col">
      <p>London</p>
      <p>Stolica Wielkiej Brytanii</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>Londyn</em></p>
    </div>
  ),
  ...
  "kraków": (
    <div className=" font-normal flex flex-col">
      <p>Kraków</p>
      <p>Miasto w Polsce</p>
      <p className=" font-normal mt-1">Tłumaczenie: <em>Cracow (ang.)</em></p>
    </div>
  ),
