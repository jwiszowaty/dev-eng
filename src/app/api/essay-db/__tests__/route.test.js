...
describe("POST api/essay-db", () => {
    it("should return 201 status", async () => {
        ...
        const request = new Request("http://localhost/api/essay-db", {
            method: "POST",
...
describe("GET api/essay-db?id=", () => {
    it("should return 200 status", async () => {
        const request = new NextRequest("http://localhost/api/essay-db?id=USERID", {
            method: "GET"
        });
