...
describe("POST /api/essay", () => {
    it("should check an essay and return 201 response", async () => {
        ...
        const body = {
            data: essay,
            systemInstruction: scenarios.essay.systemInstruction,
        }
        const request = new Request("http://localhost/api/essay", {
            method: "POST",
