  ...
  return (
    <div className="grid grid-cols-[280px_auto] grid-rows-[60px_auto] gap-y-[30px] w-screen h-screen">
      ...
      <div className="pt-[40px] p-10 max-w-5xl">
        ...
        <div className="mb-4">
          {wrapText(
            "The simplest and most common English sentence structure is: Subject + Verb + Object (SVO). This structure forms the foundation of clear communication."
          )}
        </div>
        ...
        {[
          [
            "She reads books.",
            "'She' is the subject, 'reads' is the verb, 'books' is the object.",
          ],
          [
            "They play football.",
        ...
        <div className="mb-4">
          {wrapText(
            "English sentences can be categorized based on their function. Each type has a specific purpose."
          )}
        </div>
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            {wrapText("Imperative – gives a command or request (.) or (!) ")}
          </li>
        ...
        {[
          ...
          [
            ...
            "Exclamatory – expressing excitement or amazement.",
          ],
        ].map(([sentence, explanation], index) => (
          <div
            key={index}
        ...
        <div className="mb-4">
          {wrapText(
            "These structures help us combine ideas in different ways to create more detailed communication."
          )}
        </div>
        <ul className="list-disc list-inside mb-4">
        ...
        {[
          ...
          [
            ...
            "Complex – the first part is a dependent clause.",
          ],
        ].map(([sentence, explanation], index) => (
          <div
            key={index}
        ...
        <div className="mb-10">
          {wrapText(
            "Start with simple sentences. As your confidence grows, explore compound and complex ones to express richer ideas."
          )}
        </div>
      </div>
    </div>
