...
export default function Dictionary() {
  ...
  return (
    <div className="grid grid-cols-[280px_auto] grid-rows-[60px_auto] w-screen h-screen">
      <NavBar />
      <SideBar />
      <div className="pt-[40px] p-10 max-w-5xl grid col-start-2 col-end-3 row-start-2 grid-rows-[auto_90px_auto_600px]">
        <div className="row-start-1 flex gap-4 place-items-center">
          <p className="text-2xl">My dictionary</p>
        ...
        <div className="row-start-4 flex flex-col overflow-y-auto h-auto border-1 w-full">
          {vocabulary?.length > 0 &&
            vocabulary.map((word) => {
              return (
